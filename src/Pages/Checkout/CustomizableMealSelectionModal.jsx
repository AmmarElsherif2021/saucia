...
import { Modal, ModalOverlay, ModalContent, ModalHeader, ModalBody, ModalFooter, ModalCloseButton, Flex, SimpleGrid, Text, Box, Button, Tag } from '@chakra-ui/react';
      ...
      <Modal isOpen={isOpen} onClose={onClose}>
        ...
        <ModalContent sx={{maxHeight: '60vh'}}>
          ...
          <ModalFooter>
            ...
            <Button colorScheme="blue" onClick={() => onConfirm(selectedItems)}>
