    ...
    return (
      <Box p={4} bg={colorMode === "dark" ? "brand.900" : "white"}>
          ...
          <Box textAlign={{ base: "center", md: "left" }}>
            ...
            <Flex mt={4} gap={3} wrap="wrap" justify={{ base: "center", md: "start" }}>
              ...
              <Flex align="center" gap={2}>
                ...
                <Text>{user.rewardPoints ?? 0} {t("rewardPoints")}</Text>
              </Flex>
            </Flex>
          </Box>
        ...
        <Modal isOpen={isOpen} onClose={onClose} size="xl" >
            ...
            <ModalContent sx={{minWidth:"60%"}}>
                ...
                <Flex gap={4} mb={6}>
                    ...
                    <Input
                        type="time"
                        defaultValue={user.nextMeal.time}
                        width={"40%"}
                    />
                    </FormControl>
               ...
               {/* Dietary Preferences */}
                ...
                <Flex wrap="wrap" gap={3}>
                    {['Vegetarian', 'Vegan', 'Gluten-Free', 'Dairy-Free', 'Keto', 'Paleo', 'Low-Carb', 'Mediterranean'].map((pref) => (
                    <Checkbox 
                        key={pref}
                ...
                <Input
                    ...
                    defaultValue={user.dietaryPreferences.filter(p => ![
                ...
                <Flex wrap="wrap" gap={3}>
                    {['Nuts', 'Shellfish', 'Soy', 'Eggs', 'Fish', 'Dairy', 'Wheat', 'Sesame'].map((allergy) => (
                    <Checkbox 
                        key={allergy}
                ...
                <Input
                    ...
                    defaultValue={user.allergies.filter(a => ![
                    'Nuts', 'Shellfish', 'Soy', 'Eggs', 'Fish', 'Dairy', 'Wheat', 'Sesame'
                    ].includes(a)).join(', ')}
                    width={"90%"}
                />
                </FormControl>
        ...
        <Tabs variant="enclosed" colorScheme="brand">
          ...
          <TabPanels mt={4}>
            <TabPanel>
              <Heading size="md" mb={4}>{t("yourMealPlan")}</Heading>
              {/* Meal plan content */}
            </TabPanel>
  
            <TabPanel>
              <Heading size="md" mb={4}>{t("orderHistory")}</Heading>
              {/* Order history content */}
            </TabPanel>
  
            <TabPanel>
              <Heading size="md" mb={4}>{t("subscriptionDetails")}</Heading>
        ...
        <Box mt={8} p={4} bg="gray.50" borderRadius="md">
          <Heading size="md" mb={4}>{t("preferences")}</Heading>
